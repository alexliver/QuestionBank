$(document).ready(function() {	
	...
	$('.node').click(function(event) {
		...
		if ($(this).children('span.node_progress').hasClass('danger')) {
			...
			$('div.node_info_close').removeClass('bx');
			$('div.node_info_close').removeClass('gx');
			$('div.node_info_close').addClass('rx');
			...
			$('.node_info h3').removeClass('success');
			$('div.node_info_close').removeClass('bx');
			$('div.node_info_close').addClass('gx');
			$('div.node_info_close').removeClass('rx');
			   setTimeout(function(){
			...
			$('.node_info h3').removeClass('danger');
			$('.node_info h3').removeClass('success');
			$('div.node_info_close').addClass('bx');
			$('div.node_info_close').removeClass('gx');
			$('div.node_info_close').removeClass('rx');
			   setTimeout(function(){
