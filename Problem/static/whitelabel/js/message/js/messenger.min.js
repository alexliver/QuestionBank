...
(function() {
	...
	var i = e.forEach,
		...
		l = n.bind,
		u = {}, c = {}, h = u.each = u.forEach = function(e, t, n) {
			if (null != e) if (i && e.forEach === i) e.forEach(t, n);
	...
	var e = function() {
		var e = /\s+/,
			t = function(t, n, s, r) {
				if (!s) return !0;
				if ("object" == typeof s) for (var i in s) t[n].apply(t, [i, s[i]].concat(r));
				else {
...
function() {
	var e, t, n, s, r, i, o, a, l, u, c = {}.hasOwnProperty,
		h = function(e, t) {
			function n() {
				this.constructor = e
			}
	...
	e = jQuery, i = null != i ? i : window.Messenger._, s = null != (l = "undefined" != typeof Backbone && null !== Backbone ? Backbone.Events : void 0) ? l : window.Messenger.Events, n = function() {
		function t(t) {
		...
		return t.prototype.setElement = function(t) {
			...
			if (e || (e = i.result(this, "events"))) {
				...
				for (s in e) {
					...
					r = s.match(t), n = r[1], a = r[2], o = i.bind(o, this), n += ".delegateEvents" + this.cid, "" === a ? l.push(this.$el.on(n, o)) : l.push(this.$el.on(n, a, o))
				}
				return l
			}
		...
		return h(n, t), n.prototype.defaults = {
			...
			for (t in n) e = n[t], s.push(this.events['click [data-action="' + t + '"] a'] = function(e) {
				return function(n) {
					return n.preventDefault(), n.stopPropagation(), r.trigger("action:" + t, e, n), e.action(n)
				}
			}(e));
			return s
			...
			for (o = e("<div class='messenger-message message alert " + t.type + " message-" + t.type + " alert-" + t.type + "'>"), t.showCloseButton && (r = e('<button type="button" class="close" data-dismiss="alert">&times;</button>'), r.click(function() {
				return p.cancel(), !0
		...
		return h(n, t), n.prototype.tagName = "ul", n.prototype.className = "messenger", n.prototype.messageDefaults = {
			...
			var e, t, n, s, r, i, o;
			for (s = !0, t = null, e = !1, o = this.history, r = 0, i = o.length; i > r; r++) n = o[r], n.$slot.removeClass("first last shown"), n.msg.shown && n.msg.rendered && (n.$slot.addClass("shown"), e = !0, t = n, s && (s = !1, n.$slot.addClass("first")));
			return null != t && t.$slot.addClass("last"), this.$el["" + (e ? "remove" : "add") + "Class"]("messenger-empty")
		...
		return h(n, t), n.prototype.doDefaults = {
			...
			return t = i.defaults(t, {
				...
				var t, s, r;
				return r = arguments[0], t = arguments.length >= 2 ? p.call(arguments, 1) : [], s = e.ajax, e.ajax = n, r.call.apply(r, [this].concat(p.call(t))), e.ajax = s
			})
		}, n.prototype._getMessage = function(e, t) {
			return e === !1 ? !1 : e === !0 || null == e || "string" != typeof e ? t : e
			...
			var e, t, n, s, r, o, a;
			for (n = arguments.length >= 1 ? p.call(arguments, 0) : [], s = null, r = null, e = null, o = 0, a = n.length; a > o; o++) t = n[o], "success" === t || "timeout" === t || "abort" === t ? s = t : null != (null != t ? t.readyState : void 0) && null != (null != t ? t.responseText : void 0) ? r = t : i.isObject(t) && (e = t);
			return [s, e, r]
		}, n.prototype.run = function() {
			var t, n, s, r, o, a, l, u, c, h, f, g = this;
			for (r = arguments[0], a = arguments[1], t = arguments.length >= 3 ? p.call(arguments, 2) : [], null == a && (a = {}), r = e.extend(!0, {}, this.messageDefaults, this.doDefaults, null != r ? r : {}), s = this._parseEvents(r.events), o = null != (h = r.messageInstance) ? h : this.newMessage(r), null != r.id && (o.options.id = r.id), null != r.progressMessage && o.update(e.extend({}, r, {
				message: r.progressMessage,
				type: "info"
			})), i.each(["error", "success"], function(n) {
				var i, l, u;
				return (null != (l = a[n]) ? l._originalHandler : void 0) && (a[n] = a[n]._originalHandler), i = null != (u = a[n]) ? u : function() {}, a[n] = function() {
					var l, u, c, h, f, m, v, y, _, w, b, M, x, C;
					return m = arguments.length >= 1 ? p.call(arguments, 0) : [], _ = g._normalizeResponse.apply(g, m), f = _[0], l = _[1], v = _[2], "success" === n && null == o.errorCount && r.showSuccessWithoutError === !1 && (r.successMessage = null), "error" === n && (null == (w = r.errorCount) && (r.errorCount = 0), r.errorCount += 1), c = g._getMessage(h = i.apply(null, m), r[n + "Message"]), "error" !== n || 0 !== (null != v ? v.status : void 0) && "abort" !== f ? "error" === n && null != r.ignoredErrorCodes && (b = null != v ? v.status : void 0, d.call(r.ignoredErrorCodes, b) >= 0) ? (o.hide(), void 0) : (u = e.extend({}, r, {
						message: c,
						type: n,
						events: null != (M = s[n]) ? M : {},
						hideOnNavigate: "success" === n
					}), "number" == typeof(null != (x = u.retry) ? x.allow : void 0) && u.retry.allow--, "error" === n && (null != v ? v.status : void 0) >= 500 && (null != (C = u.retry) ? C.allow : void 0) ? (null == u.retry.delay && (u.retry.delay = 4 > u.errorCount ? 10 : 300), u.hideAfter && (null == (y = u._hideAfter) && (u._hideAfter = u.hideAfter), u.hideAfter = u._hideAfter + u.retry.delay), u._retryActions = !0, u.actions = {
						retry: {
							label: "retry now",
							...
							delay: u.retry.delay,
							action: function() {
								return u.messageInstance = o, setTimeout(function() {
									return g["do"].apply(g, [u, a].concat(p.call(t)))
								}, 0)
							}
						},
						cancel: {
					...
					}) : u._retryActions && (delete u.actions.retry, delete u.actions.cancel, delete r._retryActions), o.update(u), c ? (e.globalMessenger(), o.show()) : o.hide()) : (o.hide(), void 0)
				}, a[n]._originalHandler = i
			}), o._actionInstance = r.action.apply(r, [a].concat(p.call(t))), l = ["done", "progress", "fail", "state", "then"], u = 0, c = l.length; c > u; u++) n = l[u], null != o[n] && delete o[n], o[n] = null != (f = o._actionInstance) ? f[n] : void 0;
			return o
		}, n.prototype["do"] = n.prototype.run, n.prototype.ajax = function() {
			var t, n;
			return n = arguments[0], t = arguments.length >= 2 ? p.call(arguments, 1) : [], n.action = e.ajax, this.run.apply(this, [n].concat(p.call(t)))
		}, n
	}(a), e.fn.messenger = function() {
		var n, s, r, o, l, u, c, h;
		return r = arguments[0], s = arguments.length >= 2 ? p.call(arguments, 1) : [], null == r && (r = {}), n = this, null != r && i.isString(r) ? (h = n.data("messenger"))[r].apply(h, s) : (l = r, null == n.data("messenger") && (a = null != (u = null != (c = Messenger.themes[l.theme]) ? c.Messenger : void 0) ? u : t, n.data("messenger", o = new a(e.extend({
			el: n
		...
		Message: r,
		Messenger: t,
		themes: null != (u = Messenger.themes) ? u : {}
