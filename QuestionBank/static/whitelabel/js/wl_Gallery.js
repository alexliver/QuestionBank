...
/*modified 65 line and further edition needed
/*----------------------------------------------------------------------*/
	...
	return this.each(function () {
		...
		if (!$this.data('wl_Gallery')) {
			...
			$items.each(function () {
				...
				if(opts.editBtn) _append.append('<a class="i_admin_user">Fang Wei</a>');
				if(opts.deleteBtn) _append.append('<a class="i_calendar_day">2013/04/13</a><a class="i_tags">数学, 高数</a>');
